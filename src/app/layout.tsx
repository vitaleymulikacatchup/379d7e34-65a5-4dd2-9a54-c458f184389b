...
export const metadata: Metadata = {
  title: "HQ Travel - Enterprise Ground Transportation Platform",
  description: "AI-powered ground transportation platform for enterprises. Global coverage across 1000+ cities with automated booking, policy enforcement, and cost control.",
  keywords: "enterprise travel, ground transportation, business travel platform, AI booking, corporate travel management",
  metadataBase: new URL("https://hqtravel.com"),
  alternates: {
    canonical: "https://hqtravel.com"
  },
  openGraph: {
    title: "HQ Travel - Global Ground Transportation Platform",
    description: "Transform your enterprise ground travel with AI-powered booking and global coverage",
    url: "https://hqtravel.com",
    siteName: "HQ Travel",
    images: [
      {
        url: "https://images.pexels.com/photos/5483058/pexels-photo-5483058.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
        alt: "HQ Travel enterprise ground transportation platform"
      }
    ],
    type: "website"
  },
  twitter: {
    ...
    title: "HQ Travel - Enterprise Ground Transportation",
    description: "AI-powered platform for global ground transportation management",
    images: ["https://images.pexels.com/photos/5483058/pexels-photo-5483058.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
